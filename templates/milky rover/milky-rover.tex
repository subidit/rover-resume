...
\fancyhf{}							
\cfoot{\sffamily Rover R\'esum\'e — Page \thepage{} of \space \totalpages}

\begin{document}
	\begin{center}
		{\LARGE\AlegreyaSansMedium \so{TRIXIE B. ARGON}} \\ \bigskip
		\sffamily\so{5419 HOLLYWOOD BLVD STE C731, LOS ANGELES CA 90027} \\ \medskip
		\so{(323) 555 1435 \quad TRIXIEARGON@GMAIL.COM}
	\end{center}
