...
\usepackage[sfdefault, light]{roboto} % https://tug.org/FontCatalogue/
...
\titleformat{\section}{\color{darkgray}\large\bfseries\uppercase}{}{}{\ruleafter}[\global\RemVStrue]
\titleformat{\subsection}{\large\fontseries{m}\selectfont}{}{}{\rvs}
\titleformat{\subsubsection}{\large\slshape}{}{}{}

\usepackage{xhfill} 
\newcommand\ruleafter[1]{#1~\xrfill[.5ex]{.5pt}[gray]} % add rule after title in .5 x-height 

\newif\ifRemVS % remove vspace 
\newcommand{\rvs}{
    \ifRemVS
        \vspace{-.5ex}
    \fi
...
\usepackage[]{xcolor} % xcolor.pdf Sec.4 Colors by Name
