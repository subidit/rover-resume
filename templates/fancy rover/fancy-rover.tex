...
\titleformat{\subsubsection}{\large\fontseries{semibold}\selectfont\itshape}{}{}{}

\usepackage{xhfill} 
\newcommand\ruleafter[1]{#1~\xrfill[.5ex]{.5pt}[lightgray]} % add rule after title in .5 x-height 
...
%== HEADER ==%
\begin{center}
    {\fontsize{46}{36}\robotothin FANCY\robotoblack ROVER} \\ \medskip
